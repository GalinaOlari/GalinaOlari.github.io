...
alert('Vă rog să conectați sunetul!');
  ...
  function hBox() {
    ...
    answerText.innerHTML = "Crocodilul Ghena";
    answerText.setAttribute("class", "answerTextS");
  ...
  answerText1.innerHTML = "Cea ma frumoasă";
  answerText1.setAttribute("class", "answerTextS");
  let answerText11 = document.getElementById("answerText11");
  answerText11.innerHTML = "profesoară de informatică";
  answerText11.setAttribute("class", "answerTextS");
  let img1 = document.createElement("img");
  img1.setAttribute("src", "Galina.jpg"); img1.setAttribute("class", "answerImgS");
  ...
  answerText2.innerHTML = "Terra";
  answerText2.setAttribute("class", "answerTextS");
